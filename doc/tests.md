PageFlo has extensive test coverage in the form of Unit Tests and End-to-End (E2E)
Test suites.
...
127.0.0.1 pflo-test.local pflo-test2.local
```

## Unit Tests

PageFlo's Unit Tests validate PageFlo's public APIs and utility functions.
...
PageFlo's Unit Tests can be run from your local browser or in headless mode:
...
http://pflo-test.local:4002/unit/
...
PageFlo's End-to-End (E2E) Tests validate how PageFlo behaves in various
...
PageFlo's E2E Tests can be run from your local browser or in headless mode.
