 ...
 *
 * @class PFLO.utils.Compression
 */
(function() {
	PFLO = window.PFLO || {};
	PFLO.utils = PFLO.utils || {};

	if (PFLO.utils && PFLO.utils.Compression) {
		return;
	}

	var self = PFLO.utils.Compression = {};
	 ...
	 * @memberof PFLO.utils.Compression
	 */
