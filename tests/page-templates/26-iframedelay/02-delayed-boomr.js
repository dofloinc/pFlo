...
describe("e2e/26-iframedelay/01-delayed-pflo", function() {

	var tf = PFLO.plugins.TestFramework;
	var t = PFLO_test;

	function getIFrameBeacon(id) {
		return document.getElementById(id).contentWindow.PFLO.plugins.TestFramework.lastBeacon();
	}
	...
	it("IFrame 1 Should have only sent one page load beacon", function(done) {
		...
		w.PFLO_test.ensureBeaconCount(done, 1);
	});
