...
(function () {
	...
	window.PFLO.url =
		prefix +
		(window.PFLO_script_minified
			? "pflo-latest-debug.min.js"
			: "pflo-latest-debug.js") +
		suffix;
	/* END_TEST_CODE */
...
if (document.addEventListener) {
	document.addEventListener("onPageFloLoaded", function (e) {
		e.detail.PFLO.init({
			beacon_url: "%REACT_APP_LOG_HOST%",
			DFE: { base_url: "%REACT_APP_ETAG_BASE%" },
		});
		// TODO: create a first class dfa variable
		e.detail.PFLO.addVar("df.a", "%REACT_APP_ACCOUNT_NUMBER%", false);
